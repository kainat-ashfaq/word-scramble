...
check.addEventListener("click",function(){
  ...
  for (let j = 0; j < technology_words.length; j++) {
    ...
    if(technology_words[j].toLocaleLowerCase() == input_value){
      hint.textContent = "Correct!";
      un_scrambled_word.innerText = technology_words[j];
      input.value = ""
      break;
    }else{
...
hint.innerText = `Hint :${scrambled_words[number].hint}`;
  input.value = "";
...
var scrambled_words = [
  ...
  { word: "e n h t r e e t", hint: "A common method of networking computers in a LAN" },
  { word: "w m r i e f r a", hint: "Software that is embedded in a hardware device" },
  { word: "w l f r i a e l", hint: "A system designed to prevent unauthorized access" },
  { word: "g b y i g a e t", hint: "A unit of data storage equal to 1,024 megabytes" },
  { word: "h d a r e w r a", hint: "The physical components of a computer system" },
  {
  ...
  { word: "t o l c o r p t o", hint: "A set of rules governing data communication" },
  { word: "t y i r c u e s", hint: "Measures taken to protect a computer or network" },
  { word: "e s e s i w r l", hint: "Using radio waves to transmit data without cables" },
  { word: "h o t o t l u e b", hint: "Wireless technology standard for exchanging data" },
  { word: "e g y b t a e m", hint: "A unit of data storage equal to 1,024 kilobytes" },
  ...
  { word: "r l e p h e i a r p", hint: "External devices connected to a computer" },
  {
    word: "r m o u a s i l t",
    hint: "A program that imitates real-world processes or systems",
  },
  { word: "t a r y e t e b", hint: "A unit of data storage equal to 1,024 gigabytes" },
  {
  ...
  { word: "m e w b t s a r e", hint: "A person responsible for maintaining a website" },
  {
    word: "m p t o e u r c",
    hint: "An electronic device for storing and processing data",
  },
  ...
  { word: "n h t r e e t", hint: "A common method of networking computers in a LAN" },
  { word: "w m r i e f r a", hint: "Software that is embedded in a hardware device" },
  { word: "w l f r i e a r", hint: "A system designed to prevent unauthorized access" },
  { word: "g b y i g a e t", hint: "A unit of data storage equal to 1,024 megabytes" },
  { word: "h d a r e w r", hint: "The physical components of a computer system" },
  {
    word: "t f s o e w a r",
    hint: "The programs and other operating information used by a computer",
  },
  ...
  { word: "t i y r c u e s", hint: "Measures taken to protect a computer or network" },
  { word: "e s i w r s e l", hint: "Using radio waves to transmit data without cables" },
  { word: "h o t o t l u e b", hint: "Wireless technology standard for exchanging data" },
  { word: "e g y b t a e m", hint: "A unit of data storage equal to 1,024 kilobytes" },
  { word: "e y k o a b r d", hint: "Input device with keys used to type text" },
  {
